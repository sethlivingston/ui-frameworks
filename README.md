...
- **[research/](./research/)** — One review per framework/library (state management, rendering, event handling, AI-friendliness). Searchable with ripgrep; see [CLAUDE.md](./CLAUDE.md) for example queries. [research/frameworks.json](./research/frameworks.json) is a generated index of all reviews.
...
- **[LANGUAGE-DESIGN.md](./LANGUAGE-DESIGN.md)** — Proposal for a TypeScript-like language (StrictTS) to pair with the framework design.
